...
```
At 96.2 percent, we see a very high level of accuracy for the gradient boosting method with very few misclassifications.
...
```
The decision tree yielded an accuracy of 50.4 percent, not very impressive at all.  We can safely reject this method in favor of one of the other two.
...
```
We see that the random forest, though it took a long time to compute, yields the best accuracy of all at 99.5 percent.  Out of 3923 samples, only 19 were classified incorrectly.
